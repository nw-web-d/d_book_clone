  ...
  <div>
            ...
            <div class="pbNested">
              ...
              <div class="pbNested pbNestedWrapper" id="pbBlock2841232">
                ...
                <div id="pbBlock999" class="pbNested pbNestedWrapper">
                  <div class="pbNested">
                    ...
                    >
                      <defs>
                        <symbol id="svg-quot-left" viewBox="0 0 26 18">
                          <path
                            d="M224.244,3101.41c-5.46,2.16-8.879,6.65-8.879,11.75,0,3.66,2.159,6.18,5.4,6.18a4.787,4.787,0,0,0,5.04-4.74,4.2,4.2,0,0,0-3.24-4.26c-1.5-.42-1.5-0.42-1.74-0.66a1.761,1.761,0,0,1-.42-1.14c0-1.98,1.8-3.96,5.16-5.57Zm13.26,0c-5.46,2.16-8.88,6.65-8.88,11.75,0,3.66,2.16,6.18,5.4,6.18a4.786,4.786,0,0,0,5.039-4.74,4.2,4.2,0,0,0-3.239-4.26c-1.5-.42-1.5-0.42-1.74-0.66a1.761,1.761,0,0,1-.42-1.14c0-1.98,1.8-3.96,5.159-5.57Z"
                            transform="translate(-215.375 -3101.41)"
                          ></path>
                        </symbol>
                      </defs>
                      <defs>
                        <symbol id="svg-quot-right" viewBox="0 0 26 18">
                          <path
                            d="M293.354,3214.53c5.416-2.16,8.808-6.66,8.808-11.76,0-3.66-2.142-6.18-5.356-6.18a4.765,4.765,0,0,0-5,4.74,4.194,4.194,0,0,0,3.214,4.26c1.487,0.42,1.487.42,1.725,0.66a1.765,1.765,0,0,1,.417,1.14c0,1.98-1.785,3.96-5.118,5.58Zm-13.15,0c5.415-2.16,8.807-6.66,8.807-11.76,0-3.66-2.142-6.18-5.355-6.18a4.765,4.765,0,0,0-5,4.74,4.194,4.194,0,0,0,3.213,4.26c1.488,0.42,1.488.42,1.726,0.66a1.77,1.77,0,0,1,.417,1.14c0,1.98-1.786,3.96-5.118,5.58Z"
                            transform="translate(-278.656 -3196.59)"
                          ></path>
                        </symbol>
                      </defs>
                    </svg>
              ...
              <div class="pbNested pbNestedWrapper" id="pbBlock3324204">
                <div class="stProduct01 stBookDetail01 stNs">
                  ...
                  <ProductMainArea :product="product" />
                ...
                <div class="stBallon" id="reserveHelp01_2641099">
                  <div class="stInner">
                    <dl>
                      <dt>予約購入について</dt>
                      <dd>
                        <ul class="stListBullet01 stMarginB05">
                          <li>
                        ...
                        <ul class="stLink01 stMarginB00">
                          <li>
                            <a
                              class="dyNoCid"
                              href="https://help.honto.jp/faq_detail.html?id=10071"
                              target="_blank"
                              >発売前の電子書籍を予約する</a
                            >
                          </li>
              ...
              <div class="pbNested pbNestedWrapper" id="pbBlock3324201">
                <script type="text/javascript">
                  ...
                  HC.Ajax.onload(3324201, 'dyFirstViewLazyLoad', 'prdid=25914816&pagePath=%252Febook%252Fpd', true,
                                                 function(){if (typeof(CidSetting) !== 'undefined') {CidSetting.setCid(3324201, 'pc');}});
                  //-->
                </script>
              </div>
              <div class="pbNested pbNestedWrapper" id="pbBlock4479621">
                <script type="text/javascript">
                  ...
                  HC.Ajax.onload(4479621, 'dyMailRegistrationLazyLoad', 'prdid=25914816&pagePath=%252Febook%252Fpd', true,
                                                 function(){if (typeof(CidSetting) !== 'undefined') {CidSetting.setCid(4479621, 'pc');}});
                  //-->
                </script>
              </div>
                ...
                <script type="text/javascript">
                  ...
                  setTimeout(function() {
                    ...
                    script.src =
                      ...
                      '//dex00.deqwas.net/hontojpad/scripts/x.js?noCache=' +
              ...
              <div class="pbNested pbNestedWrapper" id="pbBlock4480192">
                <script type="text/javascript">
                  ...
                  HC.Ajax.onload(4480192, 'dyRankingLazyLoad', 'prdid=25914816', true,
                                                 function(){if (typeof(CidSetting) !== 'undefined') {CidSetting.setCid(4480192, 'pc');}});
                  //-->
                </script>
              </div>
    ...
    <script type="text/javascript" id="">
      ;(function(d, g, h, l, e, k, c, a, b, f) {
        ...
        a[c] ||
          ((a[c] = function() {
            ;(a[c + '_queue'] || (a[c + '_queue'] = [])).push(arguments)
          }),
          (b = g.createElement(h)),
          (b.charset = 'utf-8'),
          (b.async = !0),
          (b.src = l),
          (f = g.getElementsByTagName(h)[0]),
          f.parentNode.insertBefore(b, f))
      })(
        window,
        document,
        'script',
        '//cd.ladsp.com/script/pixel2_asr_p_delay.js',
        'Smn',
        'Logicad',
        'pixel_asr_p_delay'
      )
      Smn.Logicad.pixel_asr_p_delay({
        smnDelaySecondsArray: [2, 5, 10, 30],
        smnAdvertiserId: '00007555',
        smnProductGroupId: '00009714',
    ...
    <script type="text/javascript" id="">
      ;(function(d, g, h, l, e, k, c, a, b, f) {
        ...
        document,
        'script',
        'https://cd.ladsp.com/script/tt_pixel2_asr.js',
        'Smn',
        'Logicad',
        'tt_pixel2_asr'
      )
      Smn.Logicad.tt_pixel2_asr({
        smnTagProductGroupId: '9714',
        smnAdvertiserProductId: '25914816',
        defaultSmnAdvertiserId: '7555',
        defaultSmnFeedProductGroupId: '9714'
      })
    </script>

    <!-- cache datetime:2020/05/08 00:01:21, cache file name:ebook/pd.html -->
    <div
      id="stSuggest"
      class="stSuggest"
    ...
    <img
      ...
      src="~/assets/img/dnp/bf.png"
      style="display: none;"
    />
    <div style="display: none; visibility: hidden;">
      <script type="text/javascript" language="javascript">
        var yahoo_retargeting_id = '58F6MBW8U2',
    ...
    <script type="text/javascript">
      ;(function(s, m, n, l, o, g, i, c, a, d) {
        ...
        document,
        'script',
        'https://cd.ladsp.com/script/pixel2_asr.js',
        'Smn',
        'Logicad',
        'pixel_asr'
      )
      Smn.Logicad.pixel_asr({
        smnAdvertiserId: '7555',
        smnProductGroupId: '9714',
        smnAdvertiserProductId: '25914816'
      })
    </script>
...
import StBoxCarousel012 from '~/components/honto/carousel/StBoxCarousel012'
import StBoxCarousel013 from '~/components/honto/carousel/StBoxCarousel013'
import StBoxCarousel014 from '~/components/honto/carousel/StBoxCarousel014'
export default {
  layout: 'honto',
  components: {
    TopicPath,
