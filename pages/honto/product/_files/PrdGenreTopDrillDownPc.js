...
var genreTopDrillDownPc = {
    ...
    setUp : function() {
        ...
        // ドリルダウンのアクション設定
        this._node.hover(genreTopDrillDownPc._showNavigation, genreTopDrillDownPc._hideNavigation);
        // 白背景設定
    ...
    _showNavigation : function() {
        ...
        Velocity(genreTopDrillDownPc._navigation, {height:genreTopDrillDownPc._inner.height()}, {duration:500, delay:0, easing:'easeOutCubic'});
    ...
    _hideNavigation : function() {
        ...
        Velocity(genreTopDrillDownPc._navigation, 'stop');
        Velocity(genreTopDrillDownPc._navigation, {height:0}, {duration:500, delay:0, easing:'easeOutCubic'});
    ...
    _onListOver : function(e) {
        genreTopDrillDownPc._init();
        var currentIndex = Array.prototype.indexOf.call(genreTopDrillDownPc._listItem, e);
        genreTopDrillDownPc._trigger.addClass('stCurrent');

        var i = 0;
        for (i = 0; i < genreTopDrillDownPc._listItem.length; i++) {
            i === currentIndex ? jQuery(genreTopDrillDownPc._listItem[i]).addClass('stActive') : jQuery(genreTopDrillDownPc._listItem[i]).removeClass('stActive');
        };

        var topPos = jQuery(e).offset().top - genreTopDrillDownPc._list.offset().top;
        Velocity(genreTopDrillDownPc._current, 'stop');
        Velocity(genreTopDrillDownPc._current, {top:topPos, opacity:1}, {duration:300, delay:0, easing:'easeOutCubic'});
    }
};
