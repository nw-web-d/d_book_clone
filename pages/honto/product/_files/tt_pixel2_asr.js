...
(function (window, document, SCRIPT, URL, FUNCTION) {
	...
	var execute = Logicad[FUNCTION] = function (parameters) {
		...
		script.src = URL + "smnTagProductGroupId=" + getParameterAsString(parameters, "smnTagProductGroupId")
			+ makeQueryNext("smnAdvertiserProductId", getParameterAsString(parameters, "smnAdvertiserProductId"))
			+ makeQueryNext("defaultSmnAdvertiserId", getParameterAsString(parameters, "defaultSmnAdvertiserId"))
			+ makeQueryNext("defaultSmnFeedProductGroupId", getParameterAsString(parameters, "defaultSmnFeedProductGroupId"))
			+ makeQueryNext("rand", Math.random())
...
})(window, document, "script", "https://tt.ladsp.com/rta?", "tt_pixel2_asr");
