...
var reserveEBook = {
  ...
  init: function(
    ...
    reserveEBook.actionAreaSelecter =
      '#dy_reserve_ebook_' + identifier + reserveEBook.areaSelecterId
    reserveEBook.eBookReservationListLinkPc =
      '<p class="stLink01 stMarginB10"><a href="/my/account/ebookreserve.html">電子予約一覧で確認・キャンセル</a></p>'
    reserveEBook.eBookReservationListLinkSp =
      '<p class="stDocLink01 stCenter stMgBottom15"><a href="/my/account/ebookreserve.html"><span>電子予約一覧で確認・キャンセル</span></a></p>'
    reserveEBook.actionMessageSelecter =
      'dy_reserve_ebook_msg_' + identifier + reserveEBook.areaSelecterId
    reserveEBook.cid = cid
    reserveEBook.continuationModalFlg = continuationModalFlg
    reserveEBook.continuationButtonId =
      '#dy_reserve_comp_modal_' + continuationButtonId

    reserveEBook.clearMessage()
    // メッセージクリア後にクローン
    reserveEBook.buttonClone = jQuery(reserveEBook.actionAreaSelecter)
      .children()
      .clone(true)
  },
  ...
  complete: function(json) {
    ...
    if ('true' === json.result || 'ERROR_RESERVED' === json.code) {
      ...
      if (reserveEBook.displayType.match(/^pc/)) {
        ...
        if (reserveEBook.displayType === 'pcCarousel') {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<p class="stBtn"><span class="stBtn stAction stSizeXS stDisabled">予約済み</span></p>'
          )
          jQuery('#dy_reserve_ebook_msg_success').prepend(
            '<span name="dy_reserve_ebook_msg_success">予約しました <span class="stLink01"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></span></span>'
          )
        } else if (reserveEBook.displayType === 'pcDetail') {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<p><span class="stBtn stCart stSizeL stBranch01 stDisabled">予約済み</span></p>' +
              reserveEBook.eBookReservationListLinkPc
          )
          jQuery('#dy_reserve_ebook_actionAreaPc_' + resPrdId).html(
            '<p><span class="stBtn stCart stSizeL stBranch01 stDisabled">予約済み</span></p>' +
              reserveEBook.eBookReservationListLinkPc
          )
          jQuery('#dy_reserve_ebook_lineupPc_' + resPrdId).html(
            '<li><span class="stBtn stSizeM stBranch01 stDisabled">予約済み</span></li>' +
              reserveEBook.eBookReservationListLinkPc
          )
        } else if (reserveEBook.displayType === 'pcCampaign1') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<p class="stMarginB05"><span class="stBtn stSizeM stBranch01 stDisabled">予約済み</span></p>' +
              '<p class="stLink01 stMarginB10"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
        } else if (reserveEBook.displayType === 'pcCampaign1SrsFirst') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<p class="stMarginB05"><span class="stBtn stSizeM stDisabled stSeriesReserved">始めの巻を<br/>予約済み</span></p>' +
              '<p class="stLink01 stMarginB10" style="text-align: left"><a class="stFont14px" href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
        } else if (reserveEBook.displayType === 'pcCampaign1SrsLatest') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<p class="stMarginB05"><span class="stBtn stSizeM stDisabled stSeriesReserved">最新巻を<br/>予約済み</span></p>' +
              '<p class="stLink01 stMarginB10" style="text-align: left"><a class="stFont14px" href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
          ...
          jQuery(
            ...
            '<p class="stBtn"><span class="stBtn stAction stSizeM stDisabled stBranch04">予約済み</span></p>' +
              '<p class="stLink01 stMarginB10"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
          ...
          jQuery(
            ...
            '<p class="stBtn"><span class="stBtn stAction stSizeM stDisabled stSeriesReserved">始めの巻を<br/>予約済み</span></p>' +
              '<p class="stLink01 stMarginB10" style="text-align: left"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
        } else if (reserveEBook.displayType === 'pcCampaign2SrsLatest') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<p class="stBtn"><span class="stBtn stAction stSizeM stDisabled stSeriesReserved">最新巻を<br/>予約済み</span></p>' +
              '<p class="stLink01 stMarginB10" style="text-align: left"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
          ...
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<li><span class="stBtn stAction stSizeM stDisabled stBranch04">予約済み</span></li>' +
              reserveEBook.eBookReservationListLinkPc
          )
        } else if (reserveEBook.identifier == 'lb_') {
          jQuery('#dy_reserve_ebook_lb_' + resPrdId).html(
            '<span class="stBtn stAction stEbBtn stSizeM stDisabled stBranch04">予約済み</span>' +
              '<p class="stLink01 stFont11px stMarginB00"><a href="/my/account/ebookreserve.html">予約一覧を見る</a></p>'
          )
        } else {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<li><span class="stBtn stSizeM stEbBtn stBranch01 stDisabled">予約済み</span></li>' +
              reserveEBook.eBookReservationListLinkPc
          )
        }
        ...
        if (reserveEBook.displayType === 'spCarousel') {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<p><button type="button" class="stBtn stSizeXS" disabled="disabled">' +
              '予約済み' +
              '</button></p>' +
              '<p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧</span></a></p>'
          )
          jQuery('#dy_reserve_ebook_msg_success').prepend(
            '<strong name="dy_reserve_ebook_msg_success">予約しました</strong>'
          )
        } else if (reserveEBook.displayType === 'spList') {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<button type="button" class="stBtn stCart stSizeM" disabled="disabled">' +
              '予約済み' +
              '</button>' +
              '<p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
          jQuery('#dy_reserve_ebook_toggleBoxSp_' + resPrdId).html(
            '<button type="button" class="stBtn stSizeM" disabled="disabled">' +
              '予約済み' +
              '</button>' +
              '<p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
          ...
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<button type="button" class="stBtn stCart stSizeM" disabled="disabled">' +
              '予約済み' +
              '</button>' +
              '<p class="stDocLink01 stCenter stPdTop03"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
          ...
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            '<button type="button" class="stBtn stCart stSizeM" disabled="disabled">' +
              '予約済み' +
              '</button>' +
              '<p class="stDocLink01 stCenter"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else if (reserveEBook.displayType === 'spCampaign') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<button type="button" class="stBtn stSizeS" disabled="disabled">' +
              '予約済み' +
              '</button>' +
              '<p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
          ...
          jQuery(
            ...
            '<button type="button" class="stBtn stSizeM stSeriesFirstLatest" disabled="disabled"><span>始めの巻を</span>予約済み</button><p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else if (reserveEBook.displayType === 'spCampaignSrsLatestSingle') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<button type="button" class="stBtn stSizeM stSeriesFirstLatest" disabled="disabled"><span>最新巻を</span>予約済み</button><p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else if (reserveEBook.displayType === 'spCampaignSrsFirstMultiple') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<button type="button" class="stBtn stSizeS stCpSizeS stSeriesFirstLatest" disabled="disabled"><span>始めの巻を</span>予約済み</button><p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else if (reserveEBook.displayType === 'spCampaignSrsLatestMultiple') {
          jQuery(
            '#dy_reserve_ebook_' + reserveEBook.identifier + resPrdId
          ).html(
            '<button type="button" class="stBtn stSizeS stCpSizeS stSeriesFirstLatest" disabled="disabled"><span>最新巻を</span>予約済み</button><p class="stDocLink01"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else if (reserveEBook.identifier == 'lb_') {
          jQuery('#dy_reserve_ebook_lb_' + resPrdId).html(
            '<p class="stMgBottom00"><button type="button" class="stBtn stSizeXS" disabled="disabled">' +
              '予約済み' +
              '</button></p>' +
              '<p class="stDocLink01 stMgTop05 stMgBottom00"><a href="/my/account/ebookreserve.html"><span>予約一覧を見る</span></a></p>'
          )
        } else {
          jQuery('#dy_reserve_ebook_' + resPrdId).html(
            "<ul class='stFormListButton01 stMgBottom10'><li><button type='button' class='stBtn stSizeM' disabled='disabled'>" +
              '予約済み' +
              '</button></li></ul>' +
              reserveEBook.eBookReservationListLinkSp
          )
          jQuery('#dy_reserve_ebook_actionAreaSp_' + resPrdId).html(
            "<ul class='stFormListButton01 stMgBottom10'><li><button type='button' class='stBtn stSizeM' disabled='disabled'>" +
              '予約済み' +
              '</button></li></ul>' +
              reserveEBook.eBookReservationListLinkSp
          )
          jQuery('#dy_reserve_ebook_lineupSp_' + resPrdId).html(
            "<ul class='stFormListButton01 stMgBottom10'><li><button type='button' class='stBtn stSizeM' disabled='disabled'>" +
              '予約済み' +
              '</button></li></ul>' +
              reserveEBook.eBookReservationListLinkSp
    ...
    if (
      ...
      if (
        ...
        jQuery(reserveEBook.actionAreaSelecter)
          .parent()
          .after(message)
      } else if (reserveEBook.identifier === 'lb_') {
        jQuery(reserveEBook.actionAreaSelecter)
    ...
    if (
      json.result === 'true' &&
      reserveEBook.continuationModalFlg === 'true'
    ) {
  ...
  createMessage: function(message) {
    ...
    if (
      reserveEBook.displayType.match(/^pcList/) ||
      reserveEBook.displayType === 'pcImage' ||
      reserveEBook.displayType === 'pc' ||
      (reserveEBook.displayType === 'pc' && reserveEBook.identifier === 'lb_')
    ) {
