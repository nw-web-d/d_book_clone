...
var prdMailRegistAjax = {
  ...
  _init: function(pageBlockId, productId, requestType) {
    ...
    this.buttonClone = jQuery(this.selector)
      .children()
      .clone(true)
  },
  ...
  add: function(pageBlockId, productId, requestType) {
    if (!HC.isSubmitted) {
      ...
      HC.Ajax.json(
        this.pageBlockId,
        this.complete,
        'prdid=' + this.productId + '&' + this.requestType + '=true',
        false,
        'dy_ReqEbkBtn',
        'dy_ReqEbkBtn',
        this.error
  ...
  complete: function(json) {
    ...
    rewriteElements.click(function() {
      prdMailRegistAjax.add(
        prdMailRegistAjax.pageBlockId,
        prdMailRegistAjax.productId,
        rewriteHtmlParts[rewriteHtmlIndex].requestType
      )
    })
