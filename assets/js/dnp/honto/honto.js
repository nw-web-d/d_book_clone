...
Honto.Common.Ajax = {
   ...
   */
  loadingImage: HC.DEF_DBG
    ? './library/img/pc/corusel_loading.gif'
    : '//image.honto.jp/library/img/pc/corusel_loading.gif',
...
;(function($) {
  ...
  $.extend(Honto.Common.Ajax, {
    ...
    update: function(
      ...
      parameters = Honto.Common.Ajax._getParameters(
        pageBlockId,
        parameters,
        {
          isPart: isPart,
      ...
      if (container) {
        ...
        if (HC.Ajax.loadingFunction) {
          ...
          if (width > 50 && height > 50) {
            ...
            loading.append(
              $(
                "<img src='" +
                  ...
                  (-(HC.Ajax.loadingImageHeight / 2) + top) +
                  'px;' +
                  'left:' +
                  left +
                  "px;' />"
            ...
            // 横の中央位置に表示
            loading = $(
              "<div style='width:100%;text-align:center;position:relative;top:" +
                top +
                'px;' +
                +'left:' +
                left +
    ...
    _getParameters: function(pageBlockId, parameters, addition, isAppendQuery) {
      ...
      if (isAppendQuery && document.location && document.location.search) {
        ...
        parameters = Object.extend(
          document.location.search.replace(/\+/g, '%20').toQueryParams(),
          parameters
        )
      }
  ...
  Honto.Common.Window = {
    ...
    open: function(aUrl, aName, aStyle) {
      ...
      var lStyle = String.format(
        ...
        w,
        h,
        _convertYesNo(aStyle.visibleToolbar),
        _convertYesNo(aStyle.visibleAddressbar),
        _convertYesNo(aStyle.visibleStatusbar),
        _convertYesNo(aStyle.visibleMenubar),
        _convertYesNo(aStyle.visibleScrollbars),
  ...
  window.Form = {
    ...
    getElements: function(form) {
      ...
      return arr.inject([], function(elements, child) {
        if (serializers[child.tagName.toLowerCase()]) elements.push(child)
        return elements
      })
    }
  }
