const s_account = 'dnphontojpprod'
...
s.linkInternalFilters = 'javascript:,honto.jp'
s.linkLeaveQueryString = false
s.linkTrackVars = 'None'
s.linkTrackEvents = 'None'
s.visitorNamespace = 'dnp'
s.trackingServer = 'dnp.d2.sc.omtrdc.net'
s.usePlugins = true
function s_doPlugins(b) {
  b.visitorID = b.getCustomVid('s_vi_2')
  b.server = location.hostname
  b.prop7 = b.URLsplit(document.referrer, '/', 2)
  b.prop8 = b.URLsplit(document.referrer, '/', 1)
  if (!b.campaign) {
    b.campaign = b.getQueryParam('cid')
  }
  b.eVar7 = b.prop7 ? 'D=c7' : null
  b.eVar8 = b.prop8 ? 'D=c8' : null
  b.events = b.apl(b.events, 'event29', ',', 1)
  if (location.pathname.match(/\/reg\/complete\.html/)) {
    b.events = b.apl(b.events, 'event30', ',', 1)
  }
  if (location.pathname.match(/\/reg\/transition\/complete\.html/)) {
    b.events = b.apl(b.events, 'event31', ',', 1)
  }
  if (location.pathname.match(/\/my-account\/integration\/complete\.html/)) {
    b.events = b.apl(b.events, 'event32', ',', 1)
  }
  if (location.pathname.match(/\/my\/account\.html/)) {
    b.events = b.apl(b.events, 'event33', ',', 1)
  }
  if (
    location.pathname.match(/\/(netstore|ebook)\/pd[_-]{1}(.*)\.html/) ||
    location.pathname.match(/\/reg\/cart-(eb|ns)\/confirm\.html/)
  ) {
    b.events = b.apl(b.events, 'event34', ',', 1)
  }
  if (location.pathname.match(/\/(netstore|ebook)\/pd[_-]{1}(.*)\.html/)) {
    b.events = b.apl(b.events, 'event35', ',', 1)
  }
  if (location.pathname.match(/\/(netstore|ebook)\/pd[_-]{1}(.*)\.html/)) {
    b.events = b.apl(b.events, 'event36', ',', 1)
  }
  if (location.pathname.match(/\/reg\/cart-eb\/complete\.html/)) {
    b.events = b.apl(b.events, 'event37', ',', 1)
  }
  if (location.pathname.match(/\/my\/account\/mystore\.html/)) {
    b.events = b.apl(b.events, 'event38', ',', 1)
  }
  const a = location.href
    .replace(/[?&]sessionid=(.*)/, '')
    .replace(/[?&]uid=(.*)/, '')
  b.prop61 = b.getLayer(b.pageName, '/', 1)
  b.eVar61 = 'D=c61'
  b.prop62 = b.getLayer(b.pageName, '/', 2)
  b.eVar62 = 'D=c62'
  b.prop63 = b.getLayer(b.pageName, '/', 3)
  b.eVar63 = 'D=c63'
  b.prop64 = a
  b.eVar64 = 'D=c64'
  b.prop65 = 'D=User-Agent'
  b.eVar65 = 'D=User-Agent'
  b.prop66 = 'D=v0'
  b.eVar66 = 'D=v0'
  b.prop67 = 'D=v0'
  b.eVar67 = 'D=v0'
  b.prop68 = b.getQueryParam('partnerid')
  b.eVar68 = 'D=c68'
  b.prop69 = b.getNewRepeat()
  b.eVar69 = 'D=c69'
  b.prop72 = 'D=pageName'
  b.eVar72 = 'D=pageName'
  b.hier3 = 'D=pageName'
  b.hier4 = 'D=c64'
  b.prop75 = b.getPreviousValue(b.pageName, 'gpv_pn')
  if (b.prop75) {
    b.prop74 = b.getPercentPageViewed()
  }
}
s.doPlugins = s_doPlugins
s.getCustomVid = function(d) {
  const b = this
  let a = ''
  if (navigator.userAgent.match(/(safari|android|mobile|opera\smini)/i)) {
    ...
    if (b.bl_smart) {
      ...
      const c = new Date()
      a = c.getTime() + '' + Math.random() * 10000000000000000
...
s.URLsplit = new Function(
  'u',
  'd',
  'c',
  "var s=this;var ru='';u=u||'';u=u.split('?')[0];u=u.replace('https://','');u=u.replace('http://','');var as=u.split(d);var ul=as.length;if(ul<c){c=ul;}var i=0;for(var i=0;i<c;i++){if(i==0){ru=as[i];}else{ru=ru+d+as[i];}}return ru;"
)
...
s.getNewRepeat = new Function(
  'd',
  'cn',
  "var s=this,e=new Date(),cval,sval,ct=e.getTime();d=d?d:365;cn=cn?cn:'s_nr';e.setTime(ct+d*24*60*60*1000);cval=s.c_r(cn);if(cval.length==0){s.c_w(cn,ct+'-New',e);return'New';}sval=s.split(cval,'-');if(ct-sval[0]<30*60*1000&&sval[1]=='New'){s.c_w(cn,ct+'-New',e);return'New';}else{s.c_w(cn,ct+'-Repeat',e);return'Repeat';}"
)
...
function s_gi(k, o, C) {
    ...
    if (f) {
      for (g = 0; g < 2; g++) {
        for (h = 0; h < f.length; h++) {
          ...
          if (
            (!r || r == 's_c' || (g > 0 && r == 's_l')) &&
            (B.oun == k || (B.fs && B.sa && B.fs(B.oun, k)))
          ) {
            if (B.sa) {
              B.sa(k)
            }
  ...
  if (t < 5 || z.includes('Opera') || A.includes('Opera')) {
    q = s_ft(q)
  }
  if (!B) {
    B = new Object()
...
function s_click(a) {
  try {
    s_objectID = 'exit-link'
    s.events = a
    s.tl(this, 'o', 'exit-link')
  } catch (b) {
  } finally {
    return true
  }
