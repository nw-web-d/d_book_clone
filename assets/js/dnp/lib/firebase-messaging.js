  ...
  webpackJsonpFirebase(
    [3],
    {
      ...
      117(e, t, r) {
        ...
        const p = 'fcm_token_object_Store'
        const l = (function() {
          function e() {
          ...
          return (
            (e.prototype.r = function() {
              return this.t
                ...
                : ((this.t = new Promise(function(e, t) {
                    const r = indexedDB.open('fcm_token_details_db', 1)
                    ;(r.onerror = function(e) {
                      ...
                      (r.onupgradeneeded = function(e) {
                        ...
                        const r = t.createObjectStore(p, { keyPath: 'swScope' })
            ...
            (e.prototype.getTokenDetailsFromToken = function(e) {
              return this.r().then(function(t) {
                return new Promise(function(r, n) {
                  const o = t.transaction([p])
                  const i = o.objectStore(p)
                  const s = i.index('fcmToken')
                  const a = s.get(e)
            ...
            (e.prototype.subscribeToFCM = function(e, t, r) {
              const n = this
              const o = _(t.getKey('p256dh'))
              const i = _(t.getKey('auth'))
              let s =
                'authorized_entity=' +
                e +
                '&endpoint=' +
              ...
              const c = { method: 'POST', headers: a, body: s }
            ...
            (e.prototype.s = function(e, t, r, n, o) {
              ...
              return this.r().then(function(e) {
                return new Promise(function(t, r) {
                  const n = e.transaction([p], 'readwrite')
                  const o = n.objectStore(p)
                  const s = o.put(i)
                  ;(s.onerror = function(e) {
                    r(e.target.error)
                  }),
              ...
              return t instanceof ServiceWorkerRegistration
                ? typeof e !== 'string' || e.length === 0
                  ...
                  : this.o(e)
                      .then(function(r) {
                        if (r.length !== 0) {
                          const n = r.findIndex(function(r) {
                ...
                : this.getTokenDetailsFromToken(e).then(function(e) {
                    ...
                    return t.r().then(function(r) {
                      return new Promise(function(n, o) {
                        const i = r.transaction([p], 'readwrite')
                        const s = i.objectStore(p)
                        const a = s.delete(e.swScope)
                        ;(a.onerror = function(e) {
                          o(e.target.error)
                        }),
                          (a.onsuccess = function(r) {
                            if (r.target.result === 0)
                              return void o(
        ...
        const g = l
        const E = 'messagingSenderId'
        const T = (function() {
          function e(e) {
            const t = this
            if (
              ((this.e = new s.ErrorFactory('messaging', 'Messaging', u.map)),
              !e.options[E] || typeof e.options[E] !== 'string')
            )
          ...
          return (
            (e.prototype.getToken = function() {
              ...
              return t !== 'granted'
                ? t === 'denied'
                  ? Promise.reject(this.e.create(u.codes.NOTIFICATIONS_BLOCKED))
        ...
        const I = { PARAMS: b, TYPES_OF_MSG: m, createNewMsg: v }
        const y = {
        ...
        const k = (function(e) {
          ...
          return (
            ...
            (t.prototype.b = function() {
              ...
              const t = document.querySelector('link[rel="manifest"]')
              return (
                (this.f = t
                  ? fetch(t.href)
                      .then(function(e) {
            ...
            (t.prototype.m = function(e) {
              const t = this
              const r = e.installing || e.waiting || e.active
              return new Promise(function(n, o) {
                if (!r) return void o(t.e.create(u.codes.NO_SW_IN_REG))
                if (r.state === 'activated') return void n(e)
                if (r.state === 'redundant')
                  return void o(t.e.create(u.codes.SW_REG_REDUNDANT))
                var i = function() {
                  if (r.state === 'activated') n(e)
                  else {
                    if (r.state !== 'redundant') return
        ...
        const D = (function(e) {
          ...
          return (
            ...
            (t.prototype.v = function(e) {
              ...
              const n = this.k().then(function(e) {
                if (e) {
            ...
            (t.prototype.I = function(e) {
              const t = this
              const r = this.getToken().then(function(e) {
                if (!e) throw t.e.create(u.codes.NO_FCM_TOKEN_FOR_RESUBSCRIBE)
                let r = null
                const n = t.getTokenManager()
                return n
            ...
            (t.prototype.y = function(e) {
              ...
              if (
                ...
                const r = e.notification.data.FCM_MSG
                const n = r.notification.click_action
                if (n) {
                  const o = this.D(n)
                    .then(function(e) {
            ...
            (t.prototype.O = function(e) {
              if (e && typeof e.notification === 'object') {
            ...
            (t.prototype.w = function(e) {
              ...
              return self.clients
                .matchAll({ type: 'window', includeUncontrolled: !0 })
                .then(function(r) {
                  const n = I.createNewMsg(I.TYPES_OF_MSG.PUSH_MSG_RECEIVED, e)
                  return Promise.all(
                    r.map(function(e) {
                      return t.A(e, n)
                    })
